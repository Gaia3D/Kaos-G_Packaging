...
echo Running postinstall msvcrt-2008.bat...
...
echo Running postinstall msvcrt-2010.bat...
...
echo Running postinstall msvcrt-2013.bat...
...
echo Running postinstall python-core.bat...
